...
pub struct WebsocketReportAssertion {
    pub label: String,
    pub state: String,
}
...
pub fn render_websocket_report_markdown(report: &WebsocketReport) -> String {
    ...
    builder.push_code_section("Transcript", "json", &report.transcript_json, None, true);
