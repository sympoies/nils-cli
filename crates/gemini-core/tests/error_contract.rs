use gemini_core::{CoreError, CoreErrorCategory, ProviderCategoryHint};
use pretty_assertions::assert_eq;

#[test]
fn error_contract_preserves_category_code_and_retryable() {
...
#[test]
fn error_contract_exit_code_hints_are_stable() {
...
#[test]
fn error_contract_provider_category_hints_are_stable() {
    assert_eq!(
