...
**Demo/Validation**:
- Command(s): `./skills/tools/testing/nils-cli-checks/scripts/nils-cli-checks.sh`
...
- Delete any wrapper additions (if any) and re-run `./skills/tools/testing/nils-cli-checks/scripts/nils-cli-checks.sh`.
