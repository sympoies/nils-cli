...
- If new tests introduce instability:
  ...
  - Re-run `./.agents/skills/nils-cli-verify-required-checks/scripts/nils-cli-verify-required-checks.sh` to confirm baseline stability before re-introducing tests incrementally.
