...
export SVG_LLM_CMD="cat '$REPO_ROOT/fixtures/image-processing/llm-svg-valid.svg'"
...
export SVG_LLM_CMD="cat '$REPO_ROOT/fixtures/image-processing/llm-svg-invalid.svg'"
